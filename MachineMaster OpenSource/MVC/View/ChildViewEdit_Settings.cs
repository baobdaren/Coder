...
public class ChildViewEdit_Settings : BaseChildView
{
	...
	private void Start ( )
	{
		ControllerEdit.Instance.OnStartEditPlayerPart.AddListener(OnEditNewPlayerPart);
	}
	...
	// -- 私有方法
	// --------------- //
	private void OnEditNewPlayerPart ()
	{
		UnRegist();
		PlayerPartCtrl editingPart = ModelEdit.Instance.EditingPlayerPartCtrl;
	...
	private void Regist()
	{
		...
		{
			(ModelEdit.Instance.EditingPlayerPartCtrl as PlayerPartCtrl).Size = curValue;
		});
	}
