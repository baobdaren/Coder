...
public class EngineInterpreter : AbsInterpreter
{
	...
	{ 
		...
		return new JointMotor2D() { maxMotorTorque = 10000f + PartConfig.Instance.EngineConfig.MaxMotorPower * RawData[0], motorSpeed = RawData[0] * PartConfig.Instance.EngineConfig.MaxMotorSpeed };
	}
