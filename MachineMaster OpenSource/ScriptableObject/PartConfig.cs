...
public class PartConfig : UniqueConfigBase
{
    ...
    private PartPrefabConfig LevelPartPrefab
    {
        get
        {
			if (CurrentChapterNameCache != GameManager.Instance.SelectedChapterName)
			{
                ...
                _levelPartPrefabConfig = ChapterBundleManager.Instance.LoadPartPrefabConfig(CurrentChapterNameCache);
			}
    ...
    // --- 公有方法   
    // ------------------ //
    public GameObject InstantiatePart(PartTypes partType, GameObject parent)
    {
		...
		{
            CreateParent = new GameObject("CreateParent ???");
            CreateParent.SetActive(false);
		}
        GameObject result = Instantiate(prefab, CreateParent.transform);
        result.GetComponentInChildren<AbsPartAccessorBase>().InitAccesstor();
		...
		foreach (var item in result.GetComponentsInChildren<Transform>(true))
		{
			...
			{
                item.gameObject.layer = GameObjectLayerManager.DefaultPart;
			}
    ...
    public (float, float, bool) GetPartSizeSliderSetting(PartTypes partType)
    {
        ...
        return (config.SliderMinValue, config.SliderMaxValue, config.SliderUseWholeNum);
    }
    ...
    {
        public abstract float SliderMinValue { get; }
        public abstract float SliderMaxValue { get; }
        public abstract bool SliderUseWholeNum { get; }
    }
    ...
    public class WheelConfigData:IPartConfig
    {
        ...
        public float SizeMinScale;
        public float SizeMaxScale;
        public Vector2 WheelOrigiSize => WheelPrefab.GetComponent<SpriteRenderer>().size;

        public GameObject WheelPrefab => Instance.LevelPartPrefab.WheelPrefab ?? Instance.DefaultPartPrefabs.WheelPrefab;

        public override float SliderMinValue => SizeMinScale;
        public override float SliderMaxValue => SizeMaxScale;
		public override bool SliderUseWholeNum => false;
	}
    ...
    public class SteelConfigData : IPartConfig
    {
        ...
        public GameObject SteelPrefab => Instance.LevelPartPrefab.SteelPrefab ?? Instance.DefaultPartPrefabs.SteelPrefab;
        public override float SliderMinValue => 0;
        public override float SliderMaxValue => 0;
		public override bool SliderUseWholeNum => true;
	}

    [Serializable]
    public class SpringConfigData : IPartConfig
    {
        public GameObject SpringPrefab => Instance.LevelPartPrefab.SpringPrefab ?? Instance.DefaultPartPrefabs.SpringPrefab;
        public float SpringDistanceMinValue = 1.7f;
        public float SpringDistanceMaxValue = 10.8f;
        public override float SliderMinValue => SpringDistanceMinValue;
		public override float SliderMaxValue => SpringDistanceMaxValue;
        [HideInInspector]
		public override bool SliderUseWholeNum => false;
        [SerializeField]
        [Range(0, 1)]
    ...
    public class RopeConfigData : IPartConfig
    {
        ...
        public GameObject RopePrefab => Instance.LevelPartPrefab.RopePrefab ?? Instance.DefaultPartPrefabs.RopePrefab;

        public override float SliderMinValue => 4;
		public override float SliderMaxValue => 32;
		public override bool SliderUseWholeNum => true;
	}
    ...
    public class RailConfigData : IPartConfig
    {
        ...
        public GameObject RailPrefab => Instance.LevelPartPrefab.RailPrefab ?? Instance.DefaultPartPrefabs.RailPrefab;
        public override float SliderMinValue =>  4;
		public override float SliderMaxValue => 64;
		public override bool SliderUseWholeNum => true;
	}
	...
	{
        public GameObject PresserPrefab => Instance.LevelPartPrefab.PresserPrefab ?? Instance.DefaultPartPrefabs.PresserPrefab;
        public float SpringDistanceMinValue = 1.7f;
        public float SpringDistanceMaxValue = 10.8f;
    ...
    {
        public GameObject GearPrefab => Instance.LevelPartPrefab.GearPrefab ?? Instance.DefaultPartPrefabs.GearPrefab;
        public override float SliderMinValue => 0;
		public override float SliderMaxValue => 7;
		public override bool SliderUseWholeNum => true;
	}
	...
	{
        public GameObject AircraftEnginePrefab => Instance.LevelPartPrefab.AircraftEnginePrefab ?? Instance.DefaultPartPrefabs.AircraftEnginePrefab;
        public float PushForceMax = 10000;
        public override float SliderMinValue => 0;
		public override float SliderMaxValue => PushForceMax;
		public override bool SliderUseWholeNum => true;
	...
	{
        public GameObject EnginePrefab => Instance.LevelPartPrefab.EnginePrefab ?? Instance.DefaultPartPrefabs.EnginePrefab;
    ...
    {
        public GameObject DistanceSensorPrefab => Instance.LevelPartPrefab.DistanceSensorPrefab ?? Instance.DefaultPartPrefabs.DistanceSensorPrefab;
    ...
    {
        public GameObject AVSensorPrefab => Instance.LevelPartPrefab.AVSensorPrefab ?? Instance.DefaultPartPrefabs.AVSensorPrefab;
        public override float SliderMinValue => 0;
		public override float SliderMaxValue => 0;
		public override bool SliderUseWholeNum => true;
	}
